...
public:
  ...
  Double_t GetZD0(vector<TLorentzVector> &tracks) const;
  ...
  Double_t GetAngularityLambda(const Double_t &kappa, const Double_t &alpha) const;
  ...
  // Matching
  void ResetMatching();
  void SetClosestJet(StJet *j, Double_t d)
  {
    fClosestJets[0] = j;
    fClosestJetsDist[0] = d;
  }
  void SetSecondClosestJet(StJet *j, Double_t d)
  {
    fClosestJets[1] = j;
    fClosestJetsDist[1] = d;
  }
  ...
  StJetShapeProperties *GetShapeProperties()
  {
    if (!fJetShapeProperties)
      CreateShapeProperties();
    return fJetShapeProperties;
  }
  void CreateShapeProperties()
  {
    if (fJetShapeProperties)
      delete fJetShapeProperties;
    fJetShapeProperties = new StJetShapeProperties();
  }
