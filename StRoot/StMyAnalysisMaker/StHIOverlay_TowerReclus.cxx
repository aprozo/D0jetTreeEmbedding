...
#include "StHIOverlay_TowerReclus.h"
#include "StMemStat.h"
...
ClassImp(StHIOverlay_TowerReclus)

//________________________________________________________________________
StHIOverlay_TowerReclus::StHIOverlay_TowerReclus(const char* name, StPicoDstMaker *picoMaker, const char* outName = "", const char* filename = "") : StJetFrameworkPicoBase(name) //StMaker(name),
{
  ...
  fDebugLevel = 0;
  fRunFlag = 0;       // see StHIOverlay_TowerReclus::fRunFlagEnum
  doppAnalysis = kFALSE;
...
//
//________________________________________________________________________
StHIOverlay_TowerReclus::~StHIOverlay_TowerReclus()
{ /*  */
...
//
//________________________________________________________________________
Int_t StHIOverlay_TowerReclus::Init() {
...
//________________________________________________________________________
Int_t StHIOverlay_TowerReclus::Finish() { 
  cout << "StHIOverlay_TowerReclus::Finish()\n";
  ...
  cout<<"End of StHIOverlay_TowerReclus::Finish"<<endl;
...
void StHIOverlay_TowerReclus::Clear(Option_t *opt) {
  // fjw->Clear();
  fJets->Clear();
}
//
...
//_____________________________________________________________________________
Int_t StHIOverlay_TowerReclus::Make() {
  // fjw->Clear();
  fJets->Delete();
...
void StHIOverlay_TowerReclus::SampleMCEventsForTest(){
...
void StHIOverlay_TowerReclus::SampleMCEvents(){
...
void StHIOverlay_TowerReclus::PrepareSetOfRecoInput(int eventnum, int D0num){
...
Bool_t StHIOverlay_TowerReclus::IsTrackADescendantOfD0Daughters(int trackid){ // This is for reco tracks (Needs to be called after getting the list of discarded tracks from MC)
...
Bool_t StHIOverlay_TowerReclus::KeepTrack(int particleid, int centralitybin, double pt)
{
...
void StHIOverlay_TowerReclus::MCTracksToDiscard(int D0num){ // This is for MC tracks
...
void StHIOverlay_TowerReclus::PrepareSetOfMCTracks(int eventnum, int D0num){
...
Bool_t StHIOverlay_TowerReclus::DoesItHaveAGoodRecoJet(int eventnum){
  ...
  // Loop over all saved particles for MC in StHIOverlay_TowerReclus vectors and enter them into fastjet wrapper 
...
Bool_t StHIOverlay_TowerReclus::DoesItHaveAGoodMCJet(int eventnum){
...
vector <int> *StHIOverlay_TowerReclus::GetMCTrackListForVertex(){
...
void StHIOverlay_TowerReclus::GetAllTracksFromVertex(int vertexid, vector <int> &trackvec){
...
void StHIOverlay_TowerReclus::GetD0AndDaughters(){
  vertexids.clear();
  pionids.clear();
  kaonids.clear();
...
int StHIOverlay_TowerReclus::GetMatchedRecoTrackFromMCTrack(int mctrkid){
...
void StHIOverlay_TowerReclus::AssignTreeVariables(){
...
// vector <int> StHIOverlay_TowerReclus::TracksToToss(int stopvertex, int *)

int StHIOverlay_TowerReclus::GetMatchedBtowID(int trkbemcid, TVector3 gMom, TVector3 org, int charge){
...
TVector3 StHIOverlay_TowerReclus::FastSimMom(TVector3 p, int pid)
{
    float pt = p.Perp();
    float pt1 = pt;
...
Bool_t StHIOverlay_TowerReclus::IsItASoftEvent(){
...
Bool_t StHIOverlay_TowerReclus::GetSortedArray(Int_t indexes[], std::vector<fastjet::PseudoJet> array) const
{
