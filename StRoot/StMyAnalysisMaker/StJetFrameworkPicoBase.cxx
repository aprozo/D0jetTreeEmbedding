...
ClassImp(StJetFrameworkPicoBase)
    ...
    StJetFrameworkPicoBase::StJetFrameworkPicoBase() : StMaker(),
...
StJetFrameworkPicoBase::StJetFrameworkPicoBase(const char *name) : StMaker(name),
                                                                   doUsePrimTracks(kFALSE),
                                                                   fDebugLevel(0),
                                                                   fRunFlag(0),
                                                                   doppAnalysis(kFALSE),
...
Int_t StJetFrameworkPicoBase::Init()
{
  ...
  case StJetFrameworkPicoBase::Run12_pp200: // Run12 pp (200 GeV)
    if (fBadRunListVers == StJetFrameworkPicoBase::fBadRuns_w_missing_HT)
      AddBadRuns("StRoot/StMyAnalysisMaker/runLists/Y2012_BadRuns_P12id_w_missing_HT.txt");
    if (fBadRunListVers == StJetFrameworkPicoBase::fBadRuns_wo_missing_HT)
      AddBadRuns("StRoot/StMyAnalysisMaker/runLists/Y2012_BadRuns_P12id_wo_missing_HT.txt");
    break;

  case StJetFrameworkPicoBase::Run14_AuAu200: // Run14 AuAu (200 GeV)
    if (fBadRunListVers == StJetFrameworkPicoBase::fBadRuns_w_missing_HT)
      AddBadRuns("StRoot/StMyAnalysisMaker/runLists/Y2014_BadRuns_P18ih_w_missing_HT.txt");
    if (fBadRunListVers == StJetFrameworkPicoBase::fBadRuns_wo_missing_HT)
      AddBadRuns("StRoot/StMyAnalysisMaker/runLists/Y2014_BadRuns_P18ih_wo_missing_HT.txt");
    break;

  case StJetFrameworkPicoBase::Run14_AuAu200_MB: // Run14 AuAu (200 GeV) - HFT dataset (MB trigger)
    if (fBadRunListVers == StJetFrameworkPicoBase::fBadRuns)
      AddBadRuns("StRoot/StMyAnalysisMaker/runLists/Y2014_BadRuns_P16id.txt");
    if (fBadRunListVers == StJetFrameworkPicoBase::fBadRuns_w_missing_HT)
      AddBadRuns("StRoot/StMyAnalysisMaker/runLists/Y2014_BadRuns_P18ih_w_missing_HT.txt");
    if (fBadRunListVers == StJetFrameworkPicoBase::fBadRuns_wo_missing_HT)
      AddBadRuns("StRoot/StMyAnalysisMaker/runLists/Y2014_BadRuns_P18ih_wo_missing_HT.txt");
  ...
  {
  case StJetFrameworkPicoBase::Run12_pp200: // Run12 pp (200 GeV)
    if (fBadTowerListVers == 102)
      AddBadTowers("StRoot/StMyAnalysisMaker/towerLists/Y2012_BadTowers_102.txt");
    if (fBadTowerListVers == 1)
      AddBadTowers("StRoot/StMyAnalysisMaker/towerLists/Y2012_BadTowers_Rag.txt"); // Raghav's Zg list
    if (fBadTowerListVers == 169)
      AddBadTowers("StRoot/StMyAnalysisMaker/towerLists/Y2012_AltBadTowers_155_ALT.txt"); // Alt list of 155, +14 = 169

    // tower threshold cuts
    if (fBadTowerListVers == 999)
      AddBadTowers("StRoot/StMyAnalysisMaker/towerLists/Y2012_BadTowers_P12id.txt");
    if (fBadTowerListVers == 9990200)
      AddBadTowers("StRoot/StMyAnalysisMaker/towerLists/Y2012_BadTowers_P12id_200MeV.txt");
    if (fBadTowerListVers == 9991000)
      AddBadTowers("StRoot/StMyAnalysisMaker/towerLists/Y2012_BadTowers_P12id_1000MeV.txt");
    if (fBadTowerListVers == 9992000)
      AddBadTowers("StRoot/StMyAnalysisMaker/towerLists/Y2012_BadTowers_P12id_2000MeV.txt");
  ...
  case StJetFrameworkPicoBase::Run14_AuAu200: // Run14 AuAu (200 GeV)
    if (fBadTowerListVers == 1)
      AddBadTowers("StRoot/StMyAnalysisMaker/towerLists/Y2014_BadTowers.txt"); // original default
    if (fBadTowerListVers == 136)
      AddBadTowers("StRoot/StMyAnalysisMaker/towerLists/Y2014_AltBadTowers_136.txt");
    if (fBadTowerListVers == 51)
      AddBadTowers("StRoot/StMyAnalysisMaker/towerLists/Y2014_BadTowers50_ALT.txt"); // 50x + some manually added

    // P18ih - need new definitions from Nick (July 17, 2019)
    // tower threshold cuts
    if (fBadTowerListVers == 999)
      AddBadTowers("StRoot/StMyAnalysisMaker/towerLists/Y2014_BadTowers_P18ih.txt");
    if (fBadTowerListVers == 9990200)
      AddBadTowers("StRoot/StMyAnalysisMaker/towerLists/Y2014_BadTowers_P18ih_200MeV.txt");
    if (fBadTowerListVers == 9991000)
      AddBadTowers("StRoot/StMyAnalysisMaker/towerLists/Y2014_BadTowers_P18ih_1000MeV.txt");
    if (fBadTowerListVers == 9992000)
      AddBadTowers("StRoot/StMyAnalysisMaker/towerLists/Y2014_BadTowers_P18ih_2000MeV.txt");
...
Int_t StJetFrameworkPicoBase::Get4CentBin(Double_t scaledCent) const
{
  ...
  if (scaledCent >= 0 && scaledCent < 10.0)
  {
    centbin = 0;
  }
  else if (scaledCent < 20.0)
  {
    centbin = 1;
  }
  else if (scaledCent < 50.0)
  {
    centbin = 2;
  }
  else if (scaledCent <= 80.0)
  {
    centbin = 3;
  }
...
Int_t StJetFrameworkPicoBase::GetAnnuliBin(Double_t deltaR) const
{
  ...
  if (deltaR >= 0.00 && deltaR <= 0.05)
  {
    annuliBin = 0;
  }
  else if (deltaR > 0.05 && deltaR <= 0.10)
  {
    annuliBin = 1;
  }
  else if (deltaR > 0.10 && deltaR <= 0.15)
  {
    annuliBin = 2;
  }
  else if (deltaR > 0.15 && deltaR <= 0.20)
  {
    annuliBin = 3;
  }
  else if (deltaR > 0.20 && deltaR <= 0.25)
  {
    annuliBin = 4;
  }
  else if (deltaR > 0.25 && deltaR <= 0.30)
  {
    annuliBin = 5;
  }
  else if (deltaR > 0.30 && deltaR <= 0.35)
  {
    annuliBin = 6;
  }
  else if (deltaR > 0.35 && deltaR <= 0.40)
  {
    annuliBin = 7;
  }
  else if (deltaR > 0.40 && deltaR <= 0.45)
  {
    annuliBin = 8;
  }
  else if (deltaR > 0.45 && deltaR <= 0.50)
  {
    annuliBin = 9;
  }
...
Int_t StJetFrameworkPicoBase::GetJetPtBin(Double_t jetpt) const
{
  ...
  if (jetpt >= 10.0 && jetpt < 15.0)
  {
    jetPtBin = 0;
  }
  else if (jetpt >= 15.0 && jetpt < 20.0)
  {
    jetPtBin = 1;
  }
  else if (jetpt >= 20.0 && jetpt < 40.0)
  {
    jetPtBin = 2;
  }
  else if (jetpt >= 40.0 && jetpt < 60.0)
  {
    jetPtBin = 3;
  }
...
Int_t StJetFrameworkPicoBase::GetLuminosityBin(Double_t lumi) const
{
  ...
  else if (lumi > 10000 && lumi <= 20000)
  {
    lumiBin = 1;
  }
  else if (lumi > 20000 && lumi <= 30000)
  {
    lumiBin = 2;
  }
  else if (lumi > 30000 && lumi <= 40000)
  {
    lumiBin = 3;
  }
  else if (lumi > 40000 && lumi <= 50000)
  {
    lumiBin = 4;
  }
  else if (lumi > 50000 && lumi <= 60000)
  {
    lumiBin = 5;
  }
  else if (lumi > 60000 && lumi <= 70000)
  {
    lumiBin = 6;
  }
  else if (lumi > 70000 && lumi <= 80000)
  {
    lumiBin = 7;
  }
  else if (lumi > 80000 && lumi <= 90000)
  {
    lumiBin = 8;
  }
  else if (lumi > 90000 && lumi <= 100000)
  {
    lumiBin = 9;
  }
...
Double_t StJetFrameworkPicoBase::RelativeEPJET(Double_t jetAng, Double_t EPAng) const
{
  ...
  if (dphi > 1.5 * pi)
    dphi -= 2.0 * pi;
  if ((dphi > 1.0 * pi) && (dphi < 1.5 * pi))
    dphi -= 1.0 * pi;
  if ((dphi > 0.5 * pi) && (dphi < 1.0 * pi))
    dphi -= 1.0 * pi;
  ...
  if (dphi < 0 || dphi > 0.5 * TMath::Pi())
  {
    ...
    cout << "dEP not in range [0, 0.5*Pi]!"
         << " jetAng: " << jetAng << "  EPang: " << EPAng << endl;
  }
...
Bool_t StJetFrameworkPicoBase::AcceptTrack(StPicoTrack *trk, Float_t B, TVector3 Vert)
{
  ...
  if (pt < fTrackPtMinCut)
    return kFALSE;
  if (pt > fTrackPtMaxCut)
    return kFALSE; // 20.0 STAR, (increased to 30.0) 100.0 ALICE
  if ((eta < fTrackEtaMinCut) || (eta > fTrackEtaMaxCut))
    return kFALSE;
  if (phi < 0.0)
    phi += 2.0 * pi;
  if (phi > 2.0 * pi)
    phi -= 2.0 * pi;
  if ((phi < fTrackPhiMinCut) || (phi > fTrackPhiMaxCut))
    return kFALSE;
...
Double_t StJetFrameworkPicoBase::GetReactionPlane()
{
  ...
  { // remove the leading jet from ep estimate
    if (fLeadingJet)
  ...
  for (int i = 0; i < n; i++)
  {
    ...
    if (fExcludeLeadingJetsFromFit > 0 && ((TMath::Abs(eta - excludeInEta) < fJetRad * fExcludeLeadingJetsFromFit) || (TMath::Abs(eta) - fJetRad - 1.0) > 0))
      continue;
...
Bool_t StJetFrameworkPicoBase::DoComparison(int myarr[], int elems)
{
  ...
  {
    if (mPicoEvent->isTrigger(myarr[i]))
      match = kTRUE;
    if (match)
      break;
  }
...
Bool_t StJetFrameworkPicoBase::CheckForMB(Int_t RunFlag, Int_t type)
{
  ...
  case StJetFrameworkPicoBase::Run11_pp500: // Run11 pp
    ...
    case StJetFrameworkPicoBase::kVPDMB:
      if ((DoComparison(arrMB_Run11, sizeof(arrMB_Run11) / sizeof(*arrMB_Run11))))
      {
        return kTRUE;
      }
      break;
  ...
  case StJetFrameworkPicoBase::Run12_pp200: // Run12 pp (200 GeV)
    ...
    case StJetFrameworkPicoBase::kRun12main: // update if needed
      if ((DoComparison(arrMB_Run12, sizeof(arrMB_Run12) / sizeof(*arrMB_Run12))))
      {
        return kTRUE;
      }
      break;
    case StJetFrameworkPicoBase::kVPDMB:
      if ((DoComparison(arrMB_Run12extra, sizeof(arrMB_Run12extra) / sizeof(*arrMB_Run12extra))))
      {
        return kTRUE;
      }
      break;
  ...
  case StJetFrameworkPicoBase::Run13_pp510: // Run13 pp
    ...
    {
    case StJetFrameworkPicoBase::kVPDMB:
      if ((DoComparison(arrMB_Run13, sizeof(arrMB_Run13) / sizeof(*arrMB_Run13))))
      {
        return kTRUE;
      }
      break;
  ...
  case StJetFrameworkPicoBase::Run14_AuAu200: // Run14 AuAu (200 GeV)
    ...
    {
    case kRun14main:
      if ((DoComparison(arrMB_Run14, sizeof(arrMB_Run14) / sizeof(*arrMB_Run14))))
      {
        return kTRUE;
      }
      break;
    case kVPDMB5:
      if ((DoComparison(arrMB5_Run14, sizeof(arrMB5_Run14) / sizeof(*arrMB5_Run14))))
      {
        return kTRUE;
      }
      break;
    case kVPDMB30:
      if ((DoComparison(arrMB30_Run14, sizeof(arrMB30_Run14) / sizeof(*arrMB30_Run14))))
      {
        return kTRUE;
      }
      break;
  ...
  case StJetFrameworkPicoBase::Run16_AuAu200: // Run16 AuAu (200 GeV)
    ...
    {
    case kRun16main:
      if ((DoComparison(arrMB_Run16, sizeof(arrMB_Run16) / sizeof(*arrMB_Run16))))
      {
        return kTRUE;
      }
      break;
    case kVPDMB5:
      if ((DoComparison(arrMB5_Run16, sizeof(arrMB5_Run16) / sizeof(*arrMB5_Run16))))
      {
        return kTRUE;
      }
      break;
    case kVPDMB10:
      if ((DoComparison(arrMB10_Run16, sizeof(arrMB10_Run16) / sizeof(*arrMB10_Run16))))
      {
        return kTRUE;
      }
      break;
  ...
  case StJetFrameworkPicoBase::Run17_pp510: // Run17 pp (510 GeV)
    ...
    case StJetFrameworkPicoBase::kVPDMB30:
      if ((DoComparison(arrMB30_Run17, sizeof(arrMB30_Run17) / sizeof(*arrMB30_Run17))))
      {
        return kTRUE;
      }
      break;
    case StJetFrameworkPicoBase::kVPDMB100:
      if ((DoComparison(arrMB100_Run17, sizeof(arrMB100_Run17) / sizeof(*arrMB100_Run17))))
      {
        return kTRUE;
      }
      break;
    case StJetFrameworkPicoBase::kVPDMBnovtx:
      if ((DoComparison(arrMBnovtx_Run17, sizeof(arrMBnovtx_Run17) / sizeof(*arrMBnovtx_Run17))))
      {
        return kTRUE;
      }
      break;
...
Bool_t StJetFrameworkPicoBase::CheckForHT(Int_t RunFlag, Int_t type)
{
  ...
  case StJetFrameworkPicoBase::Run12_pp200: // Run12 pp (200 GeV)
    ...
    case StJetFrameworkPicoBase::kIsHT1:
      if ((DoComparison(arrHT1_Run12, sizeof(arrHT1_Run12) / sizeof(*arrHT1_Run12))))
      {
        return kTRUE;
      }
      break;
    case StJetFrameworkPicoBase::kIsHT2:
      if ((DoComparison(arrHT2_Run12, sizeof(arrHT2_Run12) / sizeof(*arrHT2_Run12))))
      {
        return kTRUE;
      }
      break;
    case StJetFrameworkPicoBase::kIsHT3:
      if ((DoComparison(arrHT3_Run12, sizeof(arrHT3_Run12) / sizeof(*arrHT3_Run12))))
      {
        return kTRUE;
      }
      break;
  ...
  case StJetFrameworkPicoBase::Run14_AuAu200: // Run14 AuAu (200 GeV)
    ...
    {
    case kIsHT1:
      if ((DoComparison(arrHT1_Run14, sizeof(arrHT1_Run14) / sizeof(*arrHT1_Run14))))
      {
        return kTRUE;
      }
      break;
    case kIsHT2:
      if ((DoComparison(arrHT2_Run14, sizeof(arrHT2_Run14) / sizeof(*arrHT2_Run14))))
      {
        return kTRUE;
      }
      break;
    case kIsHT3:
      if ((DoComparison(arrHT3_Run14, sizeof(arrHT3_Run14) / sizeof(*arrHT3_Run14))))
      {
        return kTRUE;
      }
      break;
  ...
  case StJetFrameworkPicoBase::Run16_AuAu200: // Run16 AuAu (200 GeV)
    ...
    {
    case kIsHT1:
      if ((DoComparison(arrHT1_Run16, sizeof(arrHT1_Run16) / sizeof(*arrHT1_Run16))))
      {
        return kTRUE;
      }
      break;
    case kIsHT2:
      if ((DoComparison(arrHT2_Run16, sizeof(arrHT2_Run16) / sizeof(*arrHT2_Run16))))
      {
        return kTRUE;
      }
      break;
    case kIsHT3:
      if ((DoComparison(arrHT3_Run16, sizeof(arrHT3_Run16) / sizeof(*arrHT3_Run16))))
      {
        return kTRUE;
      }
      break;
  ...
  case StJetFrameworkPicoBase::Run17_pp510: // Run17 pp (510 GeV)
    ...
    {
    case StJetFrameworkPicoBase::kIsHT1:
      if ((DoComparison(arrHT1_Run17, sizeof(arrHT1_Run17) / sizeof(*arrHT1_Run17))))
      {
        return kTRUE;
      }
      break;
    case StJetFrameworkPicoBase::kIsHT2:
      if ((DoComparison(arrHT2_Run17, sizeof(arrHT2_Run17) / sizeof(*arrHT2_Run17))))
      {
        return kTRUE;
      }
      break;
    case StJetFrameworkPicoBase::kIsHT3:
      if ((DoComparison(arrHT3_Run16, sizeof(arrHT3_Run17) / sizeof(*arrHT3_Run17))))
      {
        return kTRUE;
      }
      break;
    default: // HT3
      if ((DoComparison(arrHT3_Run17, sizeof(arrHT3_Run17) / sizeof(*arrHT3_Run17))))
      {
        return kTRUE;
      }
    }
...
Double_t StJetFrameworkPicoBase::ApplyTrackingEff(Bool_t applyEff, Double_t tpt, Double_t teta, Int_t cbin, Double_t ZDCx, Int_t effType, TFile *infile)
{
  ...
  if (fRunFlag == StJetFrameworkPicoBase::Run14_AuAu200 || fRunFlag == StJetFrameworkPicoBase::Run14_AuAu200_MB)
  {
    ...
    if (x > 4.5)
      x = 4.5; // for pt > 4.5 use value at 4.5
    int effBin = -99;
    const char *histName = "";
    ...
    */
    ...
    if (effType == StJetFrameworkPicoBase::kNormalPtEtaBased)
    {
      ...
      if (!h)
        cout << "don't have requested histogram! " << Form("%s", histName) << endl;
    ...
    if (effType == StJetFrameworkPicoBase::kPtBased || effType == StJetFrameworkPicoBase::kEtaBased)
    {
      ...
      // get efficiency
      if (effType == StJetFrameworkPicoBase::kPtBased)
        effBin = h->FindBin(x); // pt
      if (effType == StJetFrameworkPicoBase::kEtaBased)
        effBin = h->FindBin(y); // eta
      effBinContent = h->GetBinContent(effBin);
  ...
  { // the below is probably true of all pp datasets
    // cut on pt: 0.2 - 30.0 GeV
    // cut on eta: -1.0 < eta < 1.0
    // pt is flat for pp above 2.0 (1.8) GeV
    if (x > 1.8)
      x = 1.8; // for pt > 1.8 use value at 1.8
...
TH1 *StJetFrameworkPicoBase::FillEventTriggerQA(TH1 *h)
{
  ...
  if (fRunFlag == StJetFrameworkPicoBase::Run12_pp200)
  {
    ...
    if (DoComparison(arrHT1, sizeof(arrHT1) / sizeof(*arrHT1)))
    {
      h->Fill(2);
    } // HT1
    if (DoComparison(arrHT2, sizeof(arrHT2) / sizeof(*arrHT2)))
    {
      h->Fill(3);
    } // HT2
    // if(DoComparison(arrHT3, sizeof(arrHT3)/sizeof(*arrHT3))) { h->Fill(4); } // HT3
    if (DoComparison(arrMB, sizeof(arrMB) / sizeof(*arrMB)))
    {
      h->Fill(10);
    } // VPDMB
  }
  ...
  if (fRunFlag == StJetFrameworkPicoBase::Run14_AuAu200 || fRunFlag == StJetFrameworkPicoBase::Run14_AuAu200_MB)
  {
    ...
    // check if event triggers meet certain criteria and fill histos
    if (DoComparison(arrBHT1, sizeof(arrBHT1) / sizeof(*arrBHT1)))
    {
      h->Fill(2);
    } // HT1
    if (DoComparison(arrBHT2, sizeof(arrBHT2) / sizeof(*arrBHT2)))
    {
      h->Fill(3);
    } // HT2
    if (DoComparison(arrBHT3, sizeof(arrBHT3) / sizeof(*arrBHT3)))
    {
      h->Fill(4);
    } // HT3
    if (DoComparison(arrMB, sizeof(arrMB) / sizeof(*arrMB)))
    ...
    if (DoComparison(arrCentral5, sizeof(arrCentral5) / sizeof(*arrCentral5)))
    {
      h->Fill(7);
    } // Central-5
    if (DoComparison(arrCentral, sizeof(arrCentral) / sizeof(*arrCentral)))
    {
      h->Fill(8);
    } // Central & Central-mon
    if (DoComparison(arrMB5, sizeof(arrMB5) / sizeof(*arrMB5)))
    {
      h->Fill(10);
    } // VPDMB-5
    if (DoComparison(arrMB30, sizeof(arrMB30) / sizeof(*arrMB30)))
    {
      h->Fill(11);
    } // VPDMB-30

    if (DoComparison(arrBHT2, sizeof(arrBHT2) / sizeof(*arrBHT2)) && DoComparison(arrMB, sizeof(arrMB) / sizeof(*arrMB)))
    {
      h->Fill(13);
    } // HT2 && MB
    if (DoComparison(arrBHT2, sizeof(arrBHT2) / sizeof(*arrBHT2)) && DoComparison(arrMB30, sizeof(arrMB30) / sizeof(*arrMB30)))
    {
      h->Fill(14);
    } // HT2 && MB30
    if (DoComparison(arrBHT1, sizeof(arrBHT1) / sizeof(*arrBHT1)) && DoComparison(arrMB, sizeof(arrMB) / sizeof(*arrMB)))
    {
      h->Fill(15);
    } // HT1 && MB
    if (DoComparison(arrBHT1, sizeof(arrBHT1) / sizeof(*arrBHT1)) && DoComparison(arrMB30, sizeof(arrMB30) / sizeof(*arrMB30)))
    {
      h->Fill(16);
    } // HT1 && MB30
  }
  ...
  if (fRunFlag == StJetFrameworkPicoBase::Run16_AuAu200)
  {
    ...
    {
      h->Fill(7);
    } // Central-5 & Central-novtx
    if (DoComparison(arrMB5, sizeof(arrMB5) / sizeof(*arrMB5)))
    {
      h->Fill(10);
    } // VPDMB-5
    if (DoComparison(arrMB10, sizeof(arrMB10) / sizeof(*arrMB10)))
    {
      h->Fill(11);
    } // VPDMB-10
  }
...
Int_t StJetFrameworkPicoBase::GetRunNo(Int_t RunFlag, Int_t runid)
{
  ...
  if (fRunFlag == StJetFrameworkPicoBase::Run14_AuAu200_MB)
  {
    for (int i = 0; i < nRuns; i++)
    {
      if (Run14AuAu_P16id_MB_IdNo[i] == runid)
      {
        return i;
      }
    }
...
Int_t StJetFrameworkPicoBase::GetNDataSetRuns(Int_t RunFlag)
{
  ...
  if (RunFlag == StJetFrameworkPicoBase::Run12_pp200)
  {
    nDataSetRuns = 857;
  }
  if (RunFlag == StJetFrameworkPicoBase::Run14_AuAu200)
  {
    nDataSetRuns = 830;
  }
  if (RunFlag == StJetFrameworkPicoBase::Run14_AuAu200_MB)
  {
    nDataSetRuns = 1378;
  }
  if (RunFlag == StJetFrameworkPicoBase::Run16_AuAu200)
  {
    nDataSetRuns = 1359;
  }
